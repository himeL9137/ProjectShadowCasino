...
export function AnimatedPinDemo() {
  return (
    <div className="h-[40rem] w-full flex items-center justify-center bg-background dark:bg-card">
      <PinContainer title="Shadow Casino" href="/games">
        <div className="flex flex-col p-4 tracking-tight text-slate-100/50 w-[20rem] h-[20rem] bg-gradient-to-b from-slate-800/50 to-slate-800/0 backdrop-blur-sm border border-slate-700/50 rounded-2xl">
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="text-xs text-slate-400">Live Casino</div>
          </div>
          ...
          <div className="flex-1 mt-4 space-y-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-1">
                <div className="text-3xl font-bold text-sky-400">1,247</div>
